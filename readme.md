...
Приведённый выше фрагмент - для генерации оттисков поверительных клейм.
Допустимо в одном файле смешивать и поверительные клейма разных форм, и калибровочные клейма
([см. allStampsTypes.mk](stamps/tests/mf/allStampsTypes.mk)):

TODO: вставить пример кода из allStampsTypes.mk.
